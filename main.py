...
def show_selected_club(event=None):
    #this recognizes what club was selected in the html part whether it was marching band or bbal varsity or socsci
    club_name = document.getElementById("club-select").value
    #very important since this allows the text variable to include everything within the clubs var and club name (value of respective club AND the club that was chosen in html)
